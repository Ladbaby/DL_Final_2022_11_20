...
# './data/math_210421/formula_labels_210421_no_error_mathpix/'
input_label_dir = "./datasets_no_test/dev/labels_no_error/"
# './data/math_210421/formula_labels_210421_no_chinese/'
output_label_dir = "./datasets_no_test/dev/labels_no_chinese/"
chinese_label_dir = "./datasets_no_test/dev/labels_chinese/"

if not os.path.exists(output_label_dir):
    os.mkdir(output_label_dir)

if not os.path.exists(chinese_label_dir):
    os.mkdir(chinese_label_dir)
...
for label_name in tqdm(label_name_list):
    ...
    token_list = [token_list[i]
                  for i in range(len(token_list)) if token_list[i] != ' ']  # 去除空格
    # print(token_list)
    ...
    if have_chinese is not True:
        ...
        with open(chinese_label_dir + label_name, 'w', encoding='utf-8') as f:
            f.write(new_content)

    # if have_chinese is True:
    #     print()

with open('./datasets_no_test/chinese_token.txt', 'w', encoding='utf-8') as f:
